...
\subsection{Data}
We use Universal Dependencies (UD) v2.14 \citep{UD_2.14} . We are grateful for all the labour of UD-maintainers and cite here several relevant dataset-specific publications as requested: %    Akkadian-RIAO \citep{luukko_akkadian_2020}; 
