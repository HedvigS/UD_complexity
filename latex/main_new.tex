...
\textbf{Nyckelord:} morfologi, Universal Depdencies, korpus, informationsteori, överraskning
...
Our metric, described in section \ref{ours_overview} and defined in great detail in appendix \ref{sec:appendix_ours}, captures the amount of information carried by morphological features across 72 language varieties spanning 157 datasets from the Universal Dependencies corpora collection v2.14 (UD) \citep{UD_2.14}.
...
We see our study as an improvement of Ç\&R's MFH as we believe that our handling of missing features, aggregation levels and other aspects are preferable, but we acknowledge that they are similar in spirit and results. 
...
The exact procedure for calculating our metrics can be found in appendix \ref{sec:appendix_ours}.
