...
We expect python versions 3.11 and 3.12 to work similarly.
...
This directory contains one output file that is genereated by the scripts (`code/output/results/all_results.tsv`). This is the output of the entire analysis workflow and serves as the input for plotting.

The output folders that are generated by the workflow are structured as follows: 
