#!/usr/bin/env python3
# DOWNLOADED FROM https://github.com/coltekin/mcomplexity/blob/main/conllu.py 2025-11-21
# EDITED FOR FIXES
        ...
        for multi_start in sorted(self.multi):
            ...
            if index == multi_start:
                ...
                if multi_end > multi_start:
                    ...
                    self.multi[multi_start] = multi_node # FIX
...
def conllu_sentences(f):
    if isinstance(f, str):
        fp = open(f, 'r', encoding='utf-8') # FIX encoding
